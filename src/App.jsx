    ...
    return (
        <div className="container">
			...
			{activeMsg && (
				...
				>
					<svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#3c3c3ca1"><path d="M640-80 240-480l400-400 71 71-329 329 329 329-71 71Z"/></svg>
				</button>
			)}
